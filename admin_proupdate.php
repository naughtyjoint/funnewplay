...
if(isset($_POST["action"])&&($_POST["action"]=="update")){
	...
	//重新導向
	header("Location: admin_placeupdate.php?p_id=".$row_RecPro["Pla_id"]);
}
        ...
        <td class="tdrline"><form enctype="multipart/form-data" action="" method="post" name="formJoin" id="formJoin" onSubmit="return checkForm();">
          ...
          <div class="dataDiv">
			...
			<p><strong>商品描述</strong>：
               <textarea name="p_des" class="ckeditor" id="p_des" rows="4" cols="50"><?php echo $row_RecPro["Provide_des"];?></textarea>
            </p>
          ...
          <p align="center">
            ...
            <input type="button" name="Submit" value="回上一頁" onClick="location.href='admin_placeupdate.php?p_id=<?php echo $row_RecPlace["Pla_id"];?>'">
            </p>
        </form></td>
        </tr>
    </table></td>
