...
if(isset($_POST["action"])&&($_POST["action"]=="join")){
		...
		header("Location: insertprovide.php?p_id=".$p_id."&loginStats=1");
...
<table width="780" border="0" align="center" cellpadding="4" cellspacing="0">
  <tr>
    <td class="tdbline"><a href="../phpmember/index.php"><img src="images/logo1.jpg" alt="新增提供系統" width="301" height="168"></td>
  </tr>
  <tr>
        ...
        <td class="tdrline"><form enctype="multipart/form-data" action="" method="POST" name="formJoin" id="formJoin" onSubmit="return checkForm();">
          ...
          <div class="dataDiv">
			...
			<p><strong>商品描述</strong>：
               <textarea name="p_des" class="ckeditor" id="p_des" rows="4" cols="50">Write something~</textarea>
            </p>
