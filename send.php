...
if(isset($_POST["action"])&&($_POST["action"]=="join")){
		...
		header("Location: send.php?sendStats=1&id=".$row_RecBill["Bill_id"]);
...
<script language="javascript">
alert('訊息寄送成功。');
window.location.href='bill.php?id=<?php echo $_GET["id"];?>';
</script>
<?php } ?>
<div id="wrapper">
      ...
      <tr valign="top">
        <td class="tdrline"><form action="" method="POST" name="formJoin" id="formJoin" onSubmit="return checkForm();">
          ...
          <div class="dataDiv">
            ...
            <h2>傳送訊息給 <?php echo $row_RecPlace["Pla_name"]; ?></h2>
